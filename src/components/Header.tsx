          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-slide-up animation-delay-400">
            {header_cta_primary && (
              <a
                ...
                className="px-8 py-4 rounded-lg font-semibold text-white transition-all duration-300 hover:scale-105 hover:shadow-xl transform cursor-pointer"
                style={{
            ...
            {header_cta_secondary && (
              <a
                ...
                className="px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 border-2 cursor-pointer"
                style={{
