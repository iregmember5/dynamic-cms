    ...
    <header
      ...
      style={{
        ...
        backgroundImage: backgroundImageUrl
          ...
          : "none",
        // Added top padding to create space for navbar
        paddingTop: "6rem", // This creates space below navbar (adjust as needed)
        minHeight: "calc(100vh - 6rem)", // Adjust height to account for padding
      }}
    >
      {/* Content Container */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 text-center lg:text-left animate-slide-up">
            <div className="max-w-2xl">
              ...
              {header_description && (
                <p
                  className="text-lg sm:text-xl lg:text-xl xl:text-2xl mb-8 leading-relaxed animate-slide-up animation-delay-200"
                  style={{
