...
export const CTABlock: React.FC<CTABlockProps> = ({
  ...
  return (
    <section className="py-20 relative overflow-hidden" style={bgStyle}>
      <style>{`
        .cta-block-overlay { background: linear-gradient(135deg, color-mix(in srgb, var(--primary-color) 90%, transparent) 0%, color-mix(in srgb, var(--accent-color) 90%, transparent) 100%); }
      `}</style>
