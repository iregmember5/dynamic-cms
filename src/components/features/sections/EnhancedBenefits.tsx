...
export const EnhancedBenefits: React.FC<EnhancedBenefitsProps> = ({
  ...
  return (
    <section className="py-16 sm:py-24 relative overflow-hidden" style={{ background: `linear-gradient(135deg, color-mix(in srgb, var(--primary-color) 3%, transparent) 0%, color-mix(in srgb, var(--accent-color) 3%, transparent) 100%)` }}>
      <style>{`
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 right-10 w-60 h-60 rounded-full opacity-5 animate-float benefits-circle-accent" style={{ animationDelay: "2s", animationDuration: "8s" }} />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit) => (
            <div key={benefit.id} className="group relative p-8 rounded-3xl bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-4 transform transition-all duration-300 group-hover:translate-x-2" style={{ color: "var(--text-color)" }}>
                  {benefit.title}
                </h3>

                {benefit.stats && (
                  <div className="text-4xl font-bold mb-4 transform transition-all duration-500 group-hover:scale-110" style={{ color: "var(--primary-color)" }}>
                    {benefit.stats}
                  </div>
                )}

                <p className="text-lg leading-relaxed transform transition-all duration-300 group-hover:translate-x-1" style={{ color: "var(--neutral-color)" }}>
                  {benefit.description}
                </p>
              </div>
