        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold mb-2 group-hover:translate-x-2 transition-transform duration-300" style={{ color: "var(--text-color)" }}>
                  {card.title}
                </h3>
                {card.subtitle && (
                  <p className="text-lg mb-3 group-hover:translate-x-1 transition-transform duration-300" style={{ color: "var(--primary-color)" }}>
                    {card.subtitle}
                  </p>
                )}
                <p className="mb-4 group-hover:translate-x-1 transition-transform duration-300" style={{ color: "var(--neutral-color)" }}>
                  {card.description}
                </p>
                {card.button_text && (
                  <a
